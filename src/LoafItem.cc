...
namespace BreadBin {
    ...
    LoafItem::Type LoafItem::GetType ( ) const {
        return type_;
    }

    void LoafItem::SetName (const std::string& name) {
        name_ = name;
    }

    std::string LoafItem::GetName ( ) const {
        return name_;
    }

    void LoafItem::SetPath (const std::string& path) {
        path_ = path;
    }

    std::string LoafItem::GetPath ( ) const {
        return path_;
    }
    ...
    FileItem::FileItem (const std::string& id)
        : LoafItem(id, Type::FILE) {
    ...
    ConfigItem::ConfigItem (const std::string& id)
        : LoafItem(id, Type::CONFIG) {}

    bool ConfigItem::Execute ( ) {
        return Validate();
    }
    ...
    ScriptItem::ScriptItem (const std::string& id)
        : LoafItem(id, Type::SCRIPT) {
    ...
    WebPageItem::WebPageItem (const std::string& id)
        : LoafItem(id, Type::WEBPAGE) {
