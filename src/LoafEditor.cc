...
#include "LoafItem.h"
    ...
    bool LoafEditor::AddApplication (const std::string& id, const std::string& name, const std::string& path) {
        if (!current_loaf_) {
            return false;
        }
    ...
    bool LoafEditor::AddFile (const std::string& id, const std::string& name, const std::string& path) {
        if (!current_loaf_) {
            return false;
        }
    ...
    bool LoafEditor::AddConfig (const std::string& id, const std::string& name, const std::string& path) {
        if (!current_loaf_) {
            return false;
        }
    ...
    bool LoafEditor::AddScript (const std::string& id, const std::string& name, const std::string& path) {
        if (!current_loaf_) {
            return false;
        }
    ...
    bool LoafEditor::AddWebPage (const std::string& id, const std::string& name, const std::string& url) {
        if (!current_loaf_) {
            return false;
        }
    ...
    bool LoafEditor::SetRuntimeRule (const std::string& key, const std::string& value) {
        if (!current_loaf_) {
            return false;
        }
