...
namespace BreadBin {
          ...
          paths_label_(nullptr)
    {
        ...
        default_paths << QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/BreadBin/loafs";
    ...
    void LoafBrowserWidget::SetupUI ( ) {
        ...
        paths_label_->setStyleSheet("color: #8b7a5e; font-size: 11px; padding: 4px; font-style: italic;");
    ...
    void LoafBrowserWidget::ConnectSignals ( ) {
        connect(refresh_button_, &QPushButton::clicked, this, &LoafBrowserWidget::OnRefreshClicked);
        connect(search_edit_, &QLineEdit::textChanged, this, &LoafBrowserWidget::OnSearchChanged);
        connect(file_list_, &QListWidget::itemSelectionChanged, this, &LoafBrowserWidget::OnLoafSelected);
        connect(file_list_, &QListWidget::itemDoubleClicked, [this](QListWidgetItem*) { OnOpenClicked(); });
        connect(open_button_, &QPushButton::clicked, this, &LoafBrowserWidget::OnOpenClicked);
        connect(delete_button_, &QPushButton::clicked, this, &LoafBrowserWidget::OnDeleteClicked);
    }
    ...
    void LoafBrowserWidget::ScanForLoafFiles ( ) {
        ...
        status_label_->setText(QString("Found %1 loaf files").arg(loaf_files_.size()));
    }
    ...
    void LoafBrowserWidget::OnRefreshClicked ( ) {
        RefreshLoafFiles();
    }
    ...
    void LoafBrowserWidget::OnDeleteClicked ( ) {
        ...
        if (index >= 0 && index < filtered_files_.size()) {
            QMessageBox::StandardButton reply = QMessageBox::question(
                this,
                "Confirm Delete",
                "Are you sure you want to delete '" + filtered_files_[index].name + "'?",
