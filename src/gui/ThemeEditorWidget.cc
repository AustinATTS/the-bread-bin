...
namespace BreadBin {
    namespace GUI {
        ...
        void ThemeEditorWidget::SetupUI ( ) {
            ...
            use_element_fonts_check_ = new QCheckBox("Enable individual font family per element", this);
        ...
        void ThemeEditorWidget::ConnectSignals ( ) {
            ...
            connect(use_element_fonts_check_, &QCheckBox::toggled, this, &ThemeEditorWidget::OnUseElementFontsToggled);
            connect(global_font_combo_, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &ThemeEditorWidget::OnGlobalFontChanged);
        }
        ...
        bool ThemeEditorWidget::LoadTheme (const QString &filepath) {
            if (editor_->LoadTheme(filepath.toStdString())) {
                ...
                const bool use_element_fonts = editor_->GetStyle("USE_ELEMENT_FONTS") == "true";
        ...
        bool ThemeEditorWidget::SaveTheme (const QString &filepath) {
            ...
            editor_->SetStyle("USE_ELEMENT_FONTS", use_element_fonts_check_->isChecked() ? "true" : "false");
            editor_->SetFont("global", global_font_combo_->currentText().toStdString(), editor_->GetFontSize("default"));
        ...
        void ThemeEditorWidget::OnColourChanged ( ) {
            QColor colour = QColorDialog::getColor(QColor("#d4a574"), this, "Choose Colour");
            if (colour.isValid()) {
        ...
        void ThemeEditorWidget::ApplyGlobalFontToElements ( ) {
            const std::vector<std::string> keys = {"default", "heading", "background", "foreground", "primary", "secondary", "accent"};
            const std::string global_font = global_font_combo_->currentText().toStdString();
