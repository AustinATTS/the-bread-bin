...
namespace BreadBin::GUI {
    ...
    void LoafRuntimeWidget::SetupUI ( ) {
        ...
        status_label_->setStyleSheet("font-size: 13px; color: #8b7a5e; padding: 4px;");
    ...
    void LoafRuntimeWidget::ConnectSignals ( ) {
        connect(run_button_, &QPushButton::clicked, this, &LoafRuntimeWidget::OnRunLoaf);
        connect(stop_button_, &QPushButton::clicked, this, &LoafRuntimeWidget::OnStopLoaf);
        connect(refresh_button_, &QPushButton::clicked, this, &LoafRuntimeWidget::OnRefreshStatus);
    }
    ...
    void LoafRuntimeWidget::OnRefreshStatus ( ) {
        RefreshLoafStatus();
    }

    void LoafRuntimeWidget::UpdateStatus ( ) {
        RefreshLoafStatus();
    }
