...
std::vector<AppInfo> AppDiscovery::SearchApplications(
...
std::vector<AppInfo> AppDiscovery::GetApplicationsByCategory(
...
void AppDiscovery::clear() { applications_.clear(); }
