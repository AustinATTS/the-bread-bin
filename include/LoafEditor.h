...
class LoafEditor {
 public:
  ...
  bool CloseLoaf();
  bool AddApplication(const std::string& id, const std::string& name,
                      const std::string& path);
  bool AddFile(const std::string& id, const std::string& name,
               const std::string& path);
  bool AddConfig(const std::string& id, const std::string& name,
                 const std::string& path);
  bool AddScript(const std::string& id, const std::string& name,
                 const std::string& path);
  bool AddWebPage(const std::string& id, const std::string& name,
