...
class MainWindow : public QMainWindow {
 ...
 private:
  ...
  void ApplyWarmTheme();
  void ApplyThemeFromFile(const QString& filepath,
                          bool persist_selection = true);
  [[nodiscard]] QString GetThemeSettingsFile() const;
  [[nodiscard]] QString GetDefaultLoafDirectory() const;
